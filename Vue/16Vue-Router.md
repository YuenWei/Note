...
[![img](https://github.com/zhangtianyi0110/VueLearnNotes/raw/master/17-vue-router/images/17-9.png)](https://github.com/zhangtianyi0110/VueLearnNotes/blob/master/17-vue-router/images/17-9.png)
...
通过`$route.params`获取 `$route` 所有的参数，`$route.params.userId`，获取所有参数中的名字叫`userId`的属性，此时可以在User组件中动态获取路由参数，也就可以在app.vue中动态设置路由中的`userId`，其他属性请参考 `$route` 。
...
[![img](https://github.com/zhangtianyi0110/VueLearnNotes/raw/master/17-vue-router/images/17-12.png)](https://github.com/zhangtianyi0110/VueLearnNotes/blob/master/17-vue-router/images/17-12.png)
...
[![img](https://github.com/zhangtianyi0110/VueLearnNotes/raw/master/17-vue-router/images/17-14.png)](https://github.com/zhangtianyi0110/VueLearnNotes/blob/master/17-vue-router/images/17-14.png)
...
[![img](https://github.com/zhangtianyi0110/VueLearnNotes/raw/master/17-vue-router/images/17-15.png)](https://github.com/zhangtianyi0110/VueLearnNotes/blob/master/17-vue-router/images/17-15.png)

其中index.js是入口文件，入口js文件就是导入并执行了install.js文件。

[![img](https://github.com/zhangtianyi0110/VueLearnNotes/raw/master/17-vue-router/images/17-16.png)](https://github.com/zhangtianyi0110/VueLearnNotes/blob/master/17-vue-router/images/17-16.png)

> 发现

install.js中有注册2个全局组件`RouterView`和`RouterLink`，所以我们能使用`<router-view>`和`<router-link>`组件。

[![img](https://github.com/zhangtianyi0110/VueLearnNotes/raw/master/17-vue-router/images/17-17.png)](https://github.com/zhangtianyi0110/VueLearnNotes/blob/master/17-vue-router/images/17-17.png)
...
[![img](https://github.com/zhangtianyi0110/VueLearnNotes/raw/master/17-vue-router/images/17-18.png)](https://github.com/zhangtianyi0110/VueLearnNotes/blob/master/17-vue-router/images/17-18.png)

继续来读install.js，install.js中一开始就将`Vue`这个类当参数传入了install方法中，并把`Vue`赋值给`_Vue`。

[![img](https://github.com/zhangtianyi0110/VueLearnNotes/raw/master/17-vue-router/images/17-19.png)](https://github.com/zhangtianyi0110/VueLearnNotes/blob/master/17-vue-router/images/17-19.png)
...
[![img](https://github.com/zhangtianyi0110/VueLearnNotes/raw/master/17-vue-router/images/17-20.png)](https://github.com/zhangtianyi0110/VueLearnNotes/blob/master/17-vue-router/images/17-20.png)
...
[![img](https://github.com/zhangtianyi0110/VueLearnNotes/raw/master/17-vue-router/images/17-21.gif)](https://github.com/zhangtianyi0110/VueLearnNotes/blob/master/17-vue-router/images/17-21.gif)
...
- 前置守卫和后置守卫都是**全局守卫**。
- 还有[路由独享守卫](https://router.vuejs.org/zh/guide/advanced/navigation-guards.html#路由独享的守卫)
...
[![img](https://github.com/zhangtianyi0110/VueLearnNotes/raw/master/17-vue-router/images/17-22.png)](https://github.com/zhangtianyi0110/VueLearnNotes/blob/master/17-vue-router/images/17-22.png)
...
[![img](https://github.com/zhangtianyi0110/VueLearnNotes/raw/master/17-vue-router/images/17-23.gif)](https://github.com/zhangtianyi0110/VueLearnNotes/blob/master/17-vue-router/images/17-23.gif)
...
[![img](https://github.com/zhangtianyi0110/VueLearnNotes/raw/master/17-vue-router/images/17-24.gif)](https://github.com/zhangtianyi0110/VueLearnNotes/blob/master/17-vue-router/images/17-24.gif)
...
- 使用路由守卫(组件内守卫)，`beforeRouteLeave (to, from , next)`在离开路由的时候将当前的路由赋值给path并保存起来。
  ...
  [![img](https://github.com/zhangtianyi0110/VueLearnNotes/raw/master/17-vue-router/images/17-25.gif)](https://github.com/zhangtianyi0110/VueLearnNotes/blob/master/17-vue-router/images/17-25.gif)
...
[![img](https://github.com/zhangtianyi0110/VueLearnNotes/raw/master/17-vue-router/images/17-26.gif)](https://github.com/zhangtianyi0110/VueLearnNotes/blob/master/17-vue-router/images/17-26.gif)
...
1. 在文件夹assest下新建css/base.css,用于初始化css
   ...
   ![img](https://github.com/zhangtianyi0110/VueLearnNotes/raw/master/17-vue-router/images/17-27.png)
...
<script type="text/ecmascript-6"> export default { name: 'TabBar' } </script> <style scoped> #tab-bar { display: flex; background-color: #f6f6f6;
...
[![img](https://github.com/zhangtianyi0110/VueLearnNotes/raw/master/17-vue-router/images/17-28.png)](https://github.com/zhangtianyi0110/VueLearnNotes/blob/master/17-vue-router/images/17-28.png)
...
2. 配置路由信息，参考之前的代码
   ...
   [![img](https://github.com/zhangtianyi0110/VueLearnNotes/raw/master/17-vue-router/images/17-29.png)](https://github.com/zhangtianyi0110/VueLearnNotes/blob/master/17-vue-router/images/17-29.png)
