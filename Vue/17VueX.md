...
[![img](https://github.com/zhangtianyi0110/VueLearnNotes/raw/master/19-vuex/images/19-01.png)](https://github.com/zhangtianyi0110/VueLearnNotes/blob/master/19-vuex/images/19-01.png)
...
[![img](https://github.com/zhangtianyi0110/VueLearnNotes/raw/master/19-vuex/images/19-02.gif)](https://github.com/zhangtianyi0110/VueLearnNotes/blob/master/19-vuex/images/19-02.gif)
...
[![img](https://github.com/zhangtianyi0110/VueLearnNotes/raw/master/19-vuex/images/19-03.png)](https://github.com/zhangtianyi0110/VueLearnNotes/blob/master/19-vuex/images/19-03.png)
...
[![img](https://github.com/zhangtianyi0110/VueLearnNotes/raw/master/19-vuex/images/19-04.gif)](https://github.com/zhangtianyi0110/VueLearnNotes/blob/master/19-vuex/images/19-04.gif)
...
[![img](https://github.com/zhangtianyi0110/VueLearnNotes/raw/master/19-vuex/images/19-05.png)](https://github.com/zhangtianyi0110/VueLearnNotes/blob/master/19-vuex/images/19-05.png)
...
[![img](https://github.com/zhangtianyi0110/VueLearnNotes/raw/master/19-vuex/images/19-06.gif)](https://github.com/zhangtianyi0110/VueLearnNotes/blob/master/19-vuex/images/19-06.gif)
...
4. **测试**
   ...
   [![img](https://github.com/zhangtianyi0110/VueLearnNotes/raw/master/19-vuex/images/19-07.png)](https://github.com/zhangtianyi0110/VueLearnNotes/blob/master/19-vuex/images/19-07.png)
...
7. 点击**修改信息**按钮，发现state的值变化了，但是页面没有响应变化
   ...
   [![img](https://github.com/zhangtianyi0110/VueLearnNotes/raw/master/19-vuex/images/19-08.png)](https://github.com/zhangtianyi0110/VueLearnNotes/blob/master/19-vuex/images/19-08.png)
...
9. 再次点击**修改信息**按钮，发现变响应式了
   ...
   [![img](https://github.com/zhangtianyi0110/VueLearnNotes/raw/master/19-vuex/images/19-09.png)](https://github.com/zhangtianyi0110/VueLearnNotes/blob/master/19-vuex/images/19-09.png)
...
1. 修改store的`index.js`，将mutation的方法名也改成常量使用方式
...
[![img](https://github.com/zhangtianyi0110/VueLearnNotes/raw/master/19-vuex/images/19-10.png)](https://github.com/zhangtianyi0110/VueLearnNotes/blob/master/19-vuex/images/19-10.png)
...
[![img](https://github.com/zhangtianyi0110/VueLearnNotes/raw/master/19-vuex/images/19-11.png)](https://github.com/zhangtianyi0110/VueLearnNotes/blob/master/19-vuex/images/19-11.png)

在点击按钮之后，信息修改了，dev-tools也能跟踪到state的变化。通过`$store.dispacth()`方法来调用actions，发送异步请求，在actions中需要提交mutation来修改state。

1. actions回调，在异步操作后，成功或者失败都应该会有回调，`$store.dispacth()`返回一个Promise对象，修改actions，返回一个Promise对象，成功调用`resolve(msg)`，将成功的`msg`传入（**不理解的请看一下18章的Promise对象详解**）。
...
2. 修改`aUpdateInfo()`方法，获取回调参数`msg`，此时的`response`就是actions中回调的`msg`，也可以支持失败的回调，只要actions中使用了reject，在`aUpdateInfo()`方法中catch回调结果就能获取resjct对象回传结果。
...
3. 再次点击`异步修改信息`，打印结果信息

   [![img](https://github.com/zhangtianyi0110/VueLearnNotes/raw/master/19-vuex/images/19-12.png)](https://github.com/zhangtianyi0110/VueLearnNotes/blob/master/19-vuex/images/19-12.png)
